...
class Picture extends Drawing {
    ...
    constructor(opts) {
        ...
        this._pxWidth = opts.size && opts.size.width ? opts.size.width : size.width;
        this._pxHeight = opts.size && opts.size.height ? opts.size.height : size.height;
